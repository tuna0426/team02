...
Route::get('characters/delete/{id}', [CharactersController::class, 'destroy'])->where('id','[0-9]+')->name('characters.destroy');
...
Route::get('camps/delete/{id}', [CampsController::class, 'destroy'])->where('id', '[0-9]+')->name('camps.destroy');
